        ...
        body: Column(
          children: [
            ...
            Container(
              ...
              child: Text("Versatile poultry offering succulent meat, loved for its ability to adapt to a myriad of flavors and cooking styles",
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              height: 90,
                              child: Image.asset(
                                "assets/ch_page_images/${imageIndices[index]}.png",
                                fit: BoxFit.cover,
                                width: 130,
                                height: 90,
                              ),
