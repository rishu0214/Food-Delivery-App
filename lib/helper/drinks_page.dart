        ...
        body: Column(
          children: [
            ...
            Container(
              ...
              child: Text("Fizzy beverages that offer a refreshing burst of carbonation and diverse flavors, perfect for quenching thirst and enjoyable sipping",
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              height: 90,
                              child: Image.asset(
                                "assets/sd_page_images/${imageIndices[index]}.png",
                                fit: BoxFit.cover,
                                width: 130,
                                height: 90,
                              ),
